...
## Corpus Check
- 114 files · ~74,863 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 586 nodes · 617 edges · 86 communities (60 shown, 26 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `db15ea06`
...
Cohesion: 0.36
Nodes (8): eval_single_task(), init_db(), query_llm(), Real Production AI Benchmark Evaluator for Claudia (9Router LLM Engine) Tests…, Safely execute Python code generated by LLM, auto-inspecting all variables,…, run_parallel_subagents_step(), run_safe_python(), verify_math_gpqa()
