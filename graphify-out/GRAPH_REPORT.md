...
Cohesion: 0.27
Nodes (11): compress_ast_context(), eval_single_task(), get_cache_key(), init_db(), query_llm(), Real Production AI Benchmark Evaluator for Claudia (9Router LLM Engine)…, Safely execute Python code generated by LLM, cleanly inspecting locals., Compress Python code AST removing docstrings and whitespace bloat while… (+3 more)
