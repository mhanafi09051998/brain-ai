...
## Corpus Check
- 210 files · ~203,820 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1486 nodes · 1641 edges · 175 communities (149 shown, 26 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f18ccbe5`
...
## Knowledge Gaps
- **682 isolated node(s):** `MOVIES_DATA`, `http`, `fs`, `path`, `url` (+677 more)
...
- **Why does `Color` connect `Color` to `run_self_tests`, `.from_lab`, `.build_svg`, `PaletteGenerator`?**
