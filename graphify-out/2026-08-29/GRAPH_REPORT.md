...
## Corpus Check
- 304 files · ~415,984 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2133 nodes · 2450 edges · 252 communities (219 shown, 33 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `faa63677`
...
### Community 166 - "World-Class Computer Networking & Systems Engineering: The Definitive Reference"
Cohesion: 0.10
Nodes (19): 1. The Networking Stack: Layer-by-Layer Architectural Invariants, 2. Transport Layer: TCP, UDP, QUIC, and Congestion Control, 3. Low-Level Socket Programming & Asynchronous I/O, 4. Kernel Networking, eBPF & XDP High-Speed Packet Processing, 5. Distributed Cloud Networking, CNI, & Service Mesh, 6. Network Security, Protocol Exploits, and Cryptographic Defenses, Congestion Control Algorithms, eBPF SOCKMAP & Service Mesh Acceleration (+11 more)
...
## Knowledge Gaps
- **987 isolated node(s):** `dynamic`, `dynamic`, `dynamic`, `dynamic`, `dynamic` (+982 more)
