...
## Corpus Check
- 114 files · ~74,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 585 nodes · 615 edges · 86 communities (60 shown, 26 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c33bd1fe`
...
Cohesion: 0.08
Nodes (39): fs, getConfigPath(), getDefaultMode(), getHideStatus(), getQuietStartup(), normalizeConfigMode(), normalizeMode(), normalizePersistedMode() (+31 more)
...
Nodes (37): claudeDir, {
  ...
  setMode,
  writeHookOutput,
}, fs, { getDefaultMode, getClaudeDir, isShellSafe }, { getPonytailInstructions }, mode, output, path (+29 more)
...
Cohesion: 0.39
Nodes (7): eval_single_task(), init_db(), query_llm(), Real Production AI Benchmark Evaluator for Claudia (9Router LLM Engine) Tests…, Safely execute Python code generated by LLM to verify invariant., run_parallel_subagents_step(), run_safe_python()
