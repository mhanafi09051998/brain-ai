...
def get_paths():
    ...
    repo_skills = repo_dir / "skills" if (repo_dir / "skills").exists() else repo_dir / ".agents" / "skills"
    repo_agents_md = repo_dir / "AGENTS.md"
    repo_gemini_md = repo_dir / "GEMINI.md" if (repo_dir / "GEMINI.md").exists() else repo_dir / "AGENTS.md"
