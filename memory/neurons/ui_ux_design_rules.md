...
1. **Mode Tampilan**:
   - **Default Light Mode (Mode Terang)** di seluruh 6 aplikasi web.
...
2. **Komponen Form & Interaktivitas**:
   ...
   - Semua dialog/konfirmasi harus modal in-page, dilarang popup lert()/confirm() browser.
3. **Responsivitas Ponsel**:
...
5. **Aturan Baris Kode (Maintainability Rule)**:
...
6. **Umpan Balik Error & Ketahanan Interaksi (Feedback & Interaction Resilience)**:
