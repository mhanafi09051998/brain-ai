...
asset = wd.ASSETS[0]
candles = wd.fetch_klines_twelve(asset['ticker'])
...
status_header = f'🛠️ <b>TEST REPORT (Score: {score}/5)</b>'
...
msg_template = f"""🌟 <b>Market Radar GOLD (M15)</b>
━━━━━━━━━━━━━━━━━━━━
...
wd.send_telegram_msg(msg_template)
print('Test sent!')
