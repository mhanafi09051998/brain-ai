...
- **Workspace Root**: \D:\\claudia-ultra- **Subjek**: Pusat Arsitektur & Sistem Kecerdasan Claudia Ultra. Menggabungkan mesin pembelajaran mandiri tertutup (*Closed-Loop Self-Learning & Reflexion Engine*) dari \rain-ai\ dengan pustaka keahlian rekayasa sistem tingkat tinggi (*Claudia Ultra 26 Skills Matrix*).
- **Komponen Utama**:
  1. \self_learning/\:
  ...
  2. \skills/\: Katalog 26 Core Skills modular (\skills/README.md\ & \.agents/skills.json\):
     ...
     - Frontend & Interaktif: extjs-tailwind-ui\ (App Router, Turbopack, Glassmorphism), \web-game-dev\ (Fixed Timestep 60/120 FPS, Rapier/Three.js).
     ...
     - Bahasa Performa Tinggi: \python-high-throughput\, ust-systems-programming\, \	ypescript-type-gymnastics\.
