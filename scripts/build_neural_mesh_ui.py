...
<head>
  ...
  <title>Claudia 5.0 Max — World Frontier Autonomous Neural Synapse Mesh</title>
...
<body class="relative flex items-center justify-center select-none">
  ...
  <script>
    ...
    const neuronsData = [
      ...
      { id: "N023", label: "Zero-Day Kernel Defense", category: "Security", desc: "Shadow Stack CFI, eBPF telemetry, buffer overrun protection.", conns: ["N014", "N018", "N028"] },
