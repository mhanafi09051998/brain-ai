...
- **Gaya** (OP-7.9 – OP-7.14): mulai dari hasil, yang tak terverifikasi disebut dulu; satu gagasan per kalimat ±20 kata; tanpa em-dash/kurung penjelas/panah; nama berkas/fungsi maksimal satu per kalimat, dua per paragraf; angka di tabel atau baris sendiri; daftar untuk butir paralel dengan beberapa kata pertama ditebalkan; tanpa heading di bawah ±500 kata; berhenti saat isi habis, tanpa tawaran penutup.
